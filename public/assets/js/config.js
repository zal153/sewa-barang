!(function () {
    var t = sessionStorage.getItem("__BORON_CONFIG__"),
        ...
        n =
            ((config.layout.mode = null !== n ? n : i.layout.mode),
            this.html.getAttribute("data-topbar-color")),
        n =
            ((config.topbar.color = null != n ? n : i.topbar.color),
            this.html.getAttribute("data-sidenav-size")),
        n =
            ((config.sidenav.size = null !== n ? n : i.sidenav.size),
            this.html.getAttribute("data-sidenav-user")),
        n =
            ((config.sidenav.user = null !== n || i.sidenav.user),
            this.html.getAttribute("data-menu-color"));
    if (
        ((config.menu.color = null !== n ? n : i.menu.color),
